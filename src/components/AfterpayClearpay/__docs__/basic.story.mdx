...
<Meta
  ...
  argTypes={{
    buttonColor: {
      ...
      description: `Set the button background color to black or mint. <br /> <br /> For more details about the available options, see [AfterpayClearpayButtonColor](https://developer.squareup.com/reference/sdks/web/payments/enums/AfterpayClearpayButtonColor)`,
      options: ['black', 'mint'],
      table: {
        defaultValue: {
          summary: `black`,
    ...
    buttonType: {
      ...
      description:
        'Render different copy for your button. <br /> <br /> For more details about the available options, see [AfterpayClearpayButtonType](https://developer.squareup.com/reference/sdks/web/payments/enums/AfterpayClearpayButtonType)',
      options: ['checkout_with_afterpay', 'buy_now_with_afterpay', 'place_order_with_afterpay'],
      table: {
        defaultValue: {
          summary: `long`,
        },
  ...
  component={Example}
  title="Payments/Afterpay–Clearpay"
/>

# Afterpay/Clearpay

Take a Afterpay/Clearpay payment
